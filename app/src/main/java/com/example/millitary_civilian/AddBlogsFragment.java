...
public class AddBlogsFragment extends Fragment {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageuri == null) {
                    ...
                    getLastLocation();
                    uploadData(titl, description, latitudeTextView, latitudeTextView);
                }
        ...
        switch (requestCode) {
            ...
            case PERMISSION_ID: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getContext(), "Please Enable Location Permissions", Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    ...
    private void uploadData(final String titl, final String description, String lat, String longi) {
        // show the progress dialog box
        pd.setMessage("Publishing Report");
        pd.show();
