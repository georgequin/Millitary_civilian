package com.example.millitary_civilian;
...
public class AdapterPosts extends RecyclerView.Adapter<AdapterPosts.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
       ...
       // Toast.makeText(context, nameh, Toast.LENGTH_SHORT).show();
...
//                    holder.likebtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.like_foreground, 0, 0, 0);
